        ...
        <nav class="navbar navbar-expand-lg">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link @if(request()->segment(1)=='admin' && request()->segment(2)=='') active @endif" aria-current="page" href="{{ route('admin.dashboard')}}">{{ __('dashboard.Dashboard')}}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link @if(request()->segment(1)=='admin' && request()->segment(2)=='medical-fecilities') active @endif" href="{{ route('medical-fecilities')}}">{{ __('dashboard.medical facility')}}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">{{ __('dashboard.Doctors')}}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link @if(request()->segment(1)=='admin' && request()->segment(2)=='patients') active @endif" href="{{ route('patients')}}">{{ __('dashboard.patients')}}</a>
              </li>
            </ul>
                ...
                <ul class="list-inline mb-0">
                  <li class="list-inline-item">
                    <a href="#" data-bs-toggle="dropdown" class="dropdown" aria-expanded="true">
                      <p> <img src="{{ asset('assets/img/profile.png')}}" alt="" class="me-1" /> {{Auth::user()->name}}</p>
                    </a>
