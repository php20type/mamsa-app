        ...
        <div class="box mb-5">
            <form class="search-form" accept="" method="get" action="{{ route('patients')}}">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label class="form-label">{{ __('patient.Doctor')}}</label>
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                ...
                                <a class="btn btn-primary w-100 search-btn" href="{{ route('patients')}}">{{ __('patient.Clear')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="7" class="hiddenRow">
                                <div class="accordian-body sub_sec_acc collapse ps-4 pe-4 pb-4" id="demo{{$patient->id}}">
                                    @if(isset($patient->doctors) && count($patient->doctors)>0)
                                    <div class="p-4 pb-0 ps-0">
                                        <h5>{{ __('patient.Doctors')}}</h5>
                                    </div>
                                    <table class="table sub_table">
                                        <tr>
                                            <th>{{ __('patient.First Name')}}</th>
                                            <th>{{ __('patient.Last Name')}}</th>
                                            <th>{{ __('patient.Doctor ID')}}</th>
                                        </tr>
                                    ...
                                    @endif
                                    @if(isset($patient->facilities) && count($patient->facilities)>0)
                                    <div class="p-4 pb-0 ps-0 pe-6">
                                        <h5>{{ __('patient.Facilities')}}</h5>
                                    </div>
                                    <table class="table sub_table">
                                        <tr>
...
<div class="modal EditPatients fade" id="EditPatients" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="modal-form" method="post" action="{{ route('store.patient')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                <label class="form-label">{{ __('patient.Doctor')}}:</label>
                                <div class="input-inline">
                                    <select class="selectpicker" name="doctor_ids[]" id="doctor_ids" multiple aria-label="Default select example" data-live-search="true">
                                        @foreach($doctors as $doctor)
...
<script>
    ...
    //     });
    // });
    document.getElementById('preferred_time_from').addEventListener('click', function() {
        this.showPicker(); // For some browsers like Safari
        this.focus();
    });
    document.getElementById('preferred_time_to').addEventListener('click', function() {
        this.showPicker(); // For some browsers like Safari
        this.focus();
    });
</script>
