...
@endsection
@section('content')
<section class="cust-card-area" style="padding: 0px;">
    ...
    <div class="row">
      <div class="col-md-2 px-lg-0" style="background: #6f4d3f;">
        <div class="medi-area-left">
          <div class="box-out mb-5">
            ...
            <div class="box">
              <button class="btn btn-light d-block w-100 mb-3"><a href="#" class="text-black fw-bold">Patient File</a> </button>
              <button class="btn btn-light d-block w-100 mb-3"><a href="#" class="text-black fw-bold">Coming soon</a></button>
            </div>
          </div>
          <div class="box-out mb-5">
      ...
      <div class="col-md-10">
            ...
            <div class="col">
              <div class="card border-0">
                ...
                <div class="card-body d-flex align-items-center">
                  ...
                  <h5 class="card-title text-white ms-4">Medical Alerts</h5>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card border-0">
                ...
                <div class="card-body d-flex align-items-center">
                  ...
                  <h5 class="card-title text-white ms-4">Monitored Conditions</h5>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card border-0">
                ...
                <div class="card-body d-flex align-items-center">
                  ...
                  <h5 class="card-title text-white ms-4">Prescriebd Medications</h5>
                </div>
              </div>
            </div>
            <div class="col">
              <div class="card border-0">
                ...
                <div class="card-body d-flex align-items-center">
                  ...
                  <h5 class="card-title text-white ms-4">Messages</h5>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="medi-area-right">
          <div class="box-out mb-5">
            <h3 class="heading-sm mb-4">Monitoring Period</h3>
            <div class="box">
              <div class="date-range">
                <div class="row">
                  <div class="col-lg-4">
                    <div class="d-sm-flex align-items-center">
                      <a href="#" class="me-2 arrow-back"><img src="{{ asset('assets/img/home/back.svg')}}" /> </a>
                      <a href="#" class="me-2 arrow-next"><img src="{{ asset('assets/img/home/next.svg')}}" /> </a>
                      <div class="date-show">
                  ...
                  <div class="col-lg-8">
                    <form class="date-form text-lg-end">
                      <input type="text" name="datetimes" class="border-0 btn-theme rounded">
                      <a href="#" class="btn btn-theme">Last 30 Days</a>
                      <a href="#" class="btn btn-theme">Last 90 Days</a>
                      <a href="#" class="btn btn-theme">Last 6 Months</a>
                    </form>
                  </div>
                </div>
              </div>
          ...
          <div class="box-out mb-5">
            <div class="d-sm-flex justify-content-between mb-4">
              <h3 class="heading-sm">Medical Alerts <img class="ms-2" src="{{ asset('assets/img/home/flag.svg')}}" alt="" />
              </h3>
            </div>
            <div class="cust-table">
              <table class="table mb-0">
                <thead>
                  <tr>
                    <th scope="col" width="20%" align="center" class="text-center">Check</th>
                    <th scope="col" width="50%">Medical Alerts</th>
                    <th scope="col" width="20%">Time Since <img class="ms-2" src="{{ asset('assets/img/home/flag.svg')}}" alt="" /></th>
                  </tr>
                </thead>
              </table>
                ...
                <tbody>
                  <tr>
                    <div class="show-alerts">
                      <h2>You Have <span>3</span> new medical alerts</h2>
                      <a href="#" class="btn btn-theme rounded-0">Show Alerts</a>
                    </div>
                  </tr>
                  <!-- <tr>
                     <td align="center" width="20%">
                        <input class="form-check-input" type="checkbox" value="" id="fst">
                    </td>
                     <td width="50%">Non - Advance of otherened ABC  </td>
                     <td width="20%" class="text-danger">2 Days </td>
                   </tr>
                   <tr>
                    <td align="center" width="20%">
                      <input class="form-check-input" type="checkbox" value="" id="vst">
                  </td>
                    <td width="50%">Non - Advance of otherened ABC  </td>
                    <td width="20%" class="text-danger">3 Days </td>
                  </tr>
                  <tr>
                    <td align="center" width="20%">
                      <input class="form-check-input" type="checkbox" value="" id="bst">
                    </td>
                    <td width="50%">Non - Advance of otherened ABC  </td>
                    <td width="20%" class="text-danger">4 Days </td>
                  </tr> -->
                </tbody>
              </table>
            </div>
          ...
          <div class="box-out mb-5">
            <div class="d-sm-flex justify-content-between mb-4">
              <h3 class="heading-sm">Overall Health</h3>
            </div>
            <div class="box">
          ...
          <div class="box-out mb-5">
            <div class="d-sm-flex justify-content-between mb-4">
              <h3 class="heading-sm">Monitored Conditions</h3>
            </div>
            <div class="box mb-5">
              <div class="chart-container">
                <h4>Hypertension</h4>
          ...
          <div class="box-out mb-5">
            <div class="d-sm-flex justify-content-between mb-4">
              <h3 class="heading-sm">Prescribed Treatment</h3>
            </div>
            <div class="cust-table">
              <table class="table ">
                <thead>
                  <tr>
                    <th scope="col" width="30%">Prescribed</th>
                    <th scope="col" width="50%">Monitoring</th>
                    <th scope="col" width="20%">Days Left</th>
                  </tr>
                </thead>
              </table>
              <table class="table table-bordered">
                <tbody>
                  <tr>
                    ...
                    <td width="50%">
                      <div class="status">
                        <img src="{{ asset('assets/img/home/blue-round.svg')}}">
                        <img src="{{ asset('assets/img/home/blue-round.svg')}}">
                        <img src="{{ asset('assets/img/home/blue-round.svg')}}">
                        <img src="{{ asset('assets/img/home/blue-round.svg')}}">
                        <img src="{{ asset('assets/img/home/blue-round.svg')}}">
                        <img src="{{ asset('assets/img/home/red-round.svg')}}">
                        <img src="{{ asset('assets/img/home/red-round.svg')}}">
                        <img src="{{ asset('assets/img/home/red-round.svg')}}">
                        <img src="{{ asset('assets/img/home/red-round.svg')}}">
                        <img src="{{ asset('assets/img/home/red-round.svg')}}">
                        <img src="{{ asset('assets/img/home/line.svg')}}">
                        <img src="{{ asset('assets/img/home/line.svg')}}">
                        <img src="{{ asset('assets/img/home/line.svg')}}">
                        <img src="{{ asset('assets/img/home/line.svg')}}">
                      </div>
                  ...
                  <tr>
                    ...
                    <td width="20%">7 Days </td>
                  </tr>
                  <tr>
                    <td width="30%">Different Meds YX</td>
                    <td width="50%">
                      <div class="status">
                        <img src="{{ asset('assets/img/home/blue-round.svg')}}">
                        <img src="{{ asset('assets/img/home/blue-round.svg')}}">
          ...
          <div class="box-out mb-5">
            ...
            <div class="cust-table">
              <table class="table ">
                <thead>
                  <tr>
                    <th scope="col" width="20%" align="center" class="text-center">Date</th>
                ...
                <tbody>
                  <tr>
                    <td width="20%" align="center">14.4.2024</td>
                    <td width="50%">Message XYZ </td>
                    <td width="20%"><a href="#" class="btn btn-theme w-100">Reply</a></td>
                  </tr>
                  <tr>
                    <td width="20%" align="center">14.4.2024</td>
                    <td width="50%">Message XYZ </td>
  ...
  $(document).ready(function() {
    $("input[name='datetimes']").daterangepicker({},
      function(start, end, label) {
        let startDate = start.format("MM-DD").toString();
        let endDate = end.format("MM-DD").toString();
...
<script defer>
  ...
  var myChart = new Chart(ctx, {
    type: 'line',
    data: {
      labels: ["2.4", "4.4", "6.4", "10.4", "12.4", "14.4", "16.4", "18.4", "20.4"], // Changed labels to weekdays
      datasets: [{
        label: 'Overall Health', // Legend name for the series
        data: [500, 50, 24, 140, 241, 141, 45, 55, 55, 61], // Specify the data values array
        fill: false,
        borderColor: '#fc9700', // Add custom color border (Line)
        backgroundColor: '#fc9700', // Add custom color background (Points and Fill)
    ...
    options: {
      ...
      legend: {
        ...
        boxBorderColor: 'rgba(0, 0, 0, 0)' // Make legend border invisible
      },
      scales: {
        yAxes: [{
          id: 'right-y-axis',
          ...
          gridLines: {
            color: '#f1f1f1', // Change grid color to #f1f1f1
            border: [5, 5],
            drawBorder: true // Remove right border
          }
        }],
        xAxes: [{
          ticks: {
  ...
  var myChart1 = new Chart(ctx1, {
    type: 'line',
    data: {
      labels: ["14.4", "16.4", "18.4", "20.4", "2.4", "4.4", "6.4", "10.4", "12.4"],
      datasets: [{
        label: 'Hypertension',
        data: [500, 50, 2424, 14040, 24141, 14111, 45544, 55547, 5555, 6811], // Sample data for myChart1
        fill: false,
        borderColor: '#fc9700',
      ...
      scales: {
        yAxes: [{
          ...
          gridLines: {
            color: '#f1f1f1', // Change grid color to #f1f1f1
            border: [5, 5],
            drawBorder: false // Remove right border
          }
        }],
        xAxes: [{
          ticks: {
  ...
  var myChart2 = new Chart(ctx2, {
    type: 'line',
    data: {
      labels: ["2.4", "4.4", "6.4", "10.4", "12.4", "14.4", "16.4", "18.4", "20.4"],
      datasets: [{
        label: 'Cough',
        data: [500, 50, 2424, 14040, 24141, 14111, 45544, 55547, 5555, 6811], // Sample data for myChart2
        fill: false,
        borderColor: '#fc9700',
        backgroundColor: '#fc9700',
        borderWidth: 1
